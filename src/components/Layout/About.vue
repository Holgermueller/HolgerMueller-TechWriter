<template>
  <div id="About" class="about">
    ...
    <p class="about-paragraph">
      ...
      travelling. One of my longshot dreams is to visit every country on the
      planet. Some of my bucket-list destinations are Japan, New Zealand,
      Portugal, South Africa, and Iceland. So far, I've been to Australia, the
